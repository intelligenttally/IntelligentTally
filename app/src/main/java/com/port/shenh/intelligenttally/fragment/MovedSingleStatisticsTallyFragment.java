...
import com.port.shenh.intelligenttally.work.PullMovedSingleStatisticsTally;
 ...
 * @since 1.0 2017/3/29
 */
public class MovedSingleStatisticsTallyFragment extends Fragment {

    /**
     * 日志标签前缀
     */
    private static final String LOG_TAG = "MovedSingleStatisticsTallyFragment.";
    ...
    private void loadData(boolean reload) {
        ...
        // 理货员统计列表任务
        PullMovedSingleStatisticsTally pullMovedSingleStatisticsTally = new PullMovedSingleStatisticsTally();

        pullMovedSingleStatisticsTally.setWorkEndListener(new WorkBack<List<SingleStatistics>>() {
            @Override
        ...
        // 执行任务
        pullMovedSingleStatisticsTally.beginExecute(this.ship_id);
