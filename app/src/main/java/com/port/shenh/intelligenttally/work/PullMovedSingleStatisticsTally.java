 ...
 * @since 1.0 2017/3/21
 */
public class PullMovedSingleStatisticsTally extends SimpleWorkModel<String, List<SingleStatistics>> {

    /**
     * 日志标签前缀
     */
    private  static final String LOG_TAG = "PullMovedSingleStatisticsTally.";
