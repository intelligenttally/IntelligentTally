 ...
 * @since 1.0
 */
public class VoyageOfInPortRecyclerViewAdapter extends RecyclerView.Adapter<VoyageItemViewHolder> {

    /**
     * 日志标签前缀
     */
    private static final String LOG_TAG = "VoyageOfInPortRecyclerViewAdapter.";
     ...
     * 构造函数
     */
    public VoyageOfInPortRecyclerViewAdapter() {
     ...
     */
    public VoyageOfInPortRecyclerViewAdapter(List<Voyage> dataList) {
