...
import com.port.shenh.intelligenttally.work.PullSingleStatisticsOpearte;
 ...
 * @since 1.0 2017/3/29
 */
public class SingleStatisticsOperateFragment extends Fragment {
    /**
     * 日志标签前缀
     */
    ...
    private void loadData(boolean reload) {
        ...
        // 理货员统计列表任务
        PullSingleStatisticsOpearte pullSingleStatisticsOpearte = new PullSingleStatisticsOpearte();
