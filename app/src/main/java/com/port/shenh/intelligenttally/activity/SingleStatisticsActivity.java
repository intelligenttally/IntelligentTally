...
/**
 * Created by shenh on 2017/04/25.
 */
 ...
 * @since 1.0
 */
public class SingleStatisticsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position) {
            case 0:
                // 普通
                doGeneralSingleStatistics();
                break;
            case 1:
                // 捣箱
                doMovedSingleStatistics();
                break;
            default:
                break;
        }
     ...
     * 普通个统计
     */
    private void doGeneralSingleStatistics() {
        Intent intent = new Intent(this, GeneralSingleStatisticsActivity.class);
     ...
     * 捣箱个统计
     */
    private void doMovedSingleStatistics() {
        Intent intent = new Intent(this, MovedSingleStatisticsActivity.class);
        startActivity(intent);
    }
}
