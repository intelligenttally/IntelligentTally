 ...
 * @since 1.0 2017/3/21
 */
public class PullMovedFullStatistics extends SimpleWorkModel<String, FullStatistics> {

    /**
     * 日志标签前缀
     */
    private  static final String LOG_TAG = "PullMovedFullStatistics";
    ...
    protected String onTaskUri() {
        ...
        return HttpIpSet.getHttp_ip() + StaticValue.Url.HTTP_MOVED_FULL_STATISTICS_URL;
    }
}
