 ...
 * @since 1.0
 */
public class PullShipImageListOfBay extends SimpleWorkModel<String, List<ShipImage>> {

    /**
     * 日志标签前缀
     */
    private static final String LOG_TAG = "PullShipImageListOfBay";
    ...
    protected void onFill(Map<String, String> dataMap, String... parameters) {
        ...
        dataMap.put("Bay_Num", parameters[1]);
        Log.i(LOG_TAG + " onFillRequestParameters", " Bay_Num is " + parameters[1]);
    }
