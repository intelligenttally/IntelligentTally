 ...
 * @since 1.0 2017/3/21
 */
public class PullMovedSingleStatisticsOpearte extends SimpleWorkModel<String, List<SingleStatistics>> {

    /**
     * 日志标签前缀
     */
    private  static final String LOG_TAG = "PullMovedSingleStatisticsOpearte.";
    ...
    protected String onTaskUri() {
        ...
        return HttpIpSet.getHttp_ip() + StaticValue.Url.HTTP_MOVED_SINGLE_STATISTICS_OPERATE_URL;
    }
}
