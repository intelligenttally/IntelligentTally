 ...
 * @since 1.0
 */
public class VoyageSQLiteHelper extends SQLiteOpenHelper {

    /**
     * 日志标签前缀
     */
    private static final String LOG_TAG = "VoyageSQLiteHelper.";
     ...
     * 单例连接，用于写访问
     */
    private static VoyageSQLiteHelper sqLiteOpenHelper = null;
     ...
     * @return 连接对象
     */
    public synchronized static VoyageSQLiteHelper getSqLiteOpenHelper(Context context) {
        if (sqLiteOpenHelper == null) {
            sqLiteOpenHelper = new VoyageSQLiteHelper(context);
        }
        return sqLiteOpenHelper;
    }

    public VoyageSQLiteHelper(Context context) {
