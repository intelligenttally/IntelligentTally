 ...
 * @since 1.0
 */
public class PullVoyageListOfInPort extends SimpleWorkModel<String, List<Voyage>> {

    /**
     * 日志标签前缀
     */
    private static final String LOG_TAG = "PullVoyageListOfInPort";
    ...
    protected String onTaskUri() {
        return HttpIpSet.getHttp_ip() + StaticValue.Url.HTTP_VOYAGE_LIST_OF_IN_PORT_URL;
    }
}
